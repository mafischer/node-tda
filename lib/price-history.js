 ...
 * @param {string} [opitons.frequencyType] The type of frequency with which a new candle is formed. Valid frequencyTypes by periodType (defaults marked with an asterisk): day: minute*, month: daily, weekly*, year: daily, weekly, monthly*, ytd: daily, weekly*
 * @param {string} [opitons.frequency] The number of the frequencyType to be included in each candle. Valid frequencies by frequencyType (defaults marked with an asterisk): minute: 1*, 5, 10, 15, 30, daily: 1*, weekly: 1*, monthly: 1*
